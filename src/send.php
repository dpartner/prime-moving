...
try {
    ...
    // Настройки вашей почты
    $mail->Host       = 'mail.adm.tools'; // SMTP сервера вашей почты
    $mail->Username   = 'admin@dpartner.website'; // Логин на почте
    $mail->Password   = 'DpartneR147#'; // Пароль на почте
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('admin@dpartner.website', 'admin'); // Адрес самой почты и имя отправителя
